...
conf=pyspark.SparkConf().setAppName("RF_test").set("spark.executor.memory", "8g").set("spark.executor.instances","32").set("spark.yarn.executor.memoryOverhead", "1000M").set("spark.executor.cores", "2")
...
numericCols = ["ZRow_T", "ZHints_T", "ZIncorrects_T", "ZCorrects_T", "ZRow_PN", "ZHints_PN","ZIncorrect_PN","ZCorrects_PN",              "ZRow_PU","ZHints_PU","ZIncorrect_PU","ZCorrects_PU",              "ZRow_PS","ZHints_PS","ZIncorrect_PS","ZCorrects_PS",               "ZKC1_row","ZKC1_hint","ZKC1_incorrect","ZKC1_corrects","ZKC2_row","ZKC2_hint","ZKC2_incorrect","ZKC2_corrects",              "ZKC3_row","ZKC3_hint","ZKC3_incorrect","ZKC3_corrects","ZKC4_row","ZKC4_hint","ZKC4_incorrect","ZKC4_corrects",              "ZKC5_row","ZKC5_hint","ZKC5_incorrect","ZKC5_corrects",              "ZKC_Opp1","ZKC_Opp2","ZKC_Opp3","ZKC_Opp4","ZKC_Opp5","ZKC_Opp6",              "ZProblemView","ZKCnumber"]

#Asseble all categorical variables in to one vector feature called "categAssembVec"
vecAssembler = VectorAssembler(inputCols=["ProbleNameNominalclassVec",                                          "StepNameNominalclassVec","Proble_UnitNominalclassVec","Porble_SectionNominalclassVec"], outputCol="categAssembVec")
...
#vecAssembler = VectorAssembler(inputCols=["ZRow_TNum", "ZHints_TNum", "ZIncorrects_TNum", "ZCorrects_TNum", "ZRow_PNNum", "ZHints_PNNum","ZIncorrect_PNNum","ZCorrects_PNNum",             "ZRow_PUNum","ZHints_PUNum","ZIncorrect_PUNum","ZCorrects_PUNum",            "ZRow_PSNum","ZHints_PSNum","ZIncorrect_PSNum","ZCorrects_PSNum",              "ZKC1_rowNum","ZKC1_hintNum","ZKC1_incorrectNum","ZKC1_correctsNum","ZKC2_rowNum","ZKC2_hintNum","ZKC2_incorrectNum","ZKC2_correctsNum",              "ZKC3_rowNum","ZKC3_hintNum","ZKC3_incorrectNum","ZKC3_correctsNum","ZKC4_rowNum","ZKC4_hintNum","ZKC4_incorrectNum","ZKC4_correctsNum",            "ZKC5_rowNum","ZKC5_hintNum","ZKC5_incorrectNum","ZKC5_correctsNum",             "ZKC_Opp1Num","ZKC_Opp2Num","ZKC_Opp3Num","ZKC_Opp4Num","ZKC_Opp5Num","ZKC_Opp6Num",              "ZProblemViewNum","ZKCnumberNum"], outputCol="numbAssembVec")
...
lr = LogisticRegression(labelCol="label", featuresCol="categAssembVec", maxIter=3)
...
#----------------Param tuning and CrossValidation---------------
