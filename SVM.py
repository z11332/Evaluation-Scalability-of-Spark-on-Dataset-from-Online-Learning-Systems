...
conf=pyspark.SparkConf().setAppName("SVM_test").set("spark.executor.memory", "8g").set("spark.executor.instances","32").set("spark.yarn.executor.memoryOverhead", "1000M").set("spark.executor.cores", "2")
